...
Existe dos manera de navegar a través del menú: 
	...
	2. La aplicación cuenta con una búsqueda sobre el menú, abajo a la derecha existe un campo de texto que nos permite ingresar el nombre de la utilidad que deseamos utilizar (Ventana, proceso o informe). Cuando se presiona la tecla Intro va a buscar la palabra ingresada, si existe mas de una palabra presionando de nuevo return salta a la siguiente opción. Una vez encontrada la funcionalidad con la tecla Ctrl + Intro se puede acceder a la funcionalidad. 
